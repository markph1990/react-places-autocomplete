...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PlacesAutocomplete = function (_Component) {
	  ...
	  function PlacesAutocomplete(props) {
	    ...
	    _this.state = { autocompleteItems: [], originalInputValue: "" };
	  ...
	  _createClass(PlacesAutocomplete, [{
	      ...
	      if (activeItem === undefined) {
	        ...
	        this.setState({
	          autocompleteItems: this.state.autocompleteItems.map(function (item, idx) {
	            return activeItem.index === idx ? _extends({}, item, { active: false }) : item;
	          })
	        });
	    ...
	    key: 'restoreOriginalValue',
	    value: function restoreOriginalValue() {
	...
	PlacesAutocomplete.propTypes = {
	  ...
	  saveOriginalValue: _propTypes2.default.bool,
	  restoreOriginalValueOnClear: _propTypes2.default.bool
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0c6a3f9cc87ca084f265fd2e38d7bb6f.png";
